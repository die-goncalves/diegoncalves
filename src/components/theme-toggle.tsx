  ...
  return (
    <button
      ...
      className={clsx(
        ...
        'outline-black/92 dark:outline-white/92 outline-2 outline-offset-2 focus-visible:outline',
    ...
    >
      ...
      >
        <path
          id="rays"
          className={clsx(
            'fill-black/92 dark:fill-white/92 relative origin-center',
            'ease-out-back rotate-90 duration-500 [transition-property:transform] dark:-rotate-90'
          )}
        ...
        <path
          ...
          className={clsx(
            ...
            'ease-out-back -translate-x-1 duration-500 [transition-property:transform] dark:translate-x-0'
          )}
